      ...
      <div style={{
            ...
            {[15, 25, 45, 60].map((mins) => (
              <button
                ...
                style={{
                  padding: '8px 16px',
                  borderRadius: '12px',
                  border: durationMinutes === mins ? '2px solid #e0521c' : '1px solid var(--border-color)',
                  background: durationMinutes === mins ? '#e0521c' : 'var(--bg-primary, #fff)',
        ...
        <button
          ...
          style={{
            ...
            borderRadius: '16px',
            border: 'none',
            background: isFocusActive ? '#ef4444' : '#e0521c',
            color: '#ffffff',
            fontSize: '16px',
            fontWeight: 700,
            cursor: 'pointer',
